    ...
    <div class="flex flex-col w-full">
            ...
            <div
                ...
                <div class="bg-[#80D8FB] w-full rounded-xl">
                    <div class="flex items-center justify-center space-x-5">
                        ...
                        <h1 class="text-5xl text-center leading-[130px] font-medium">Futsal</h1>
                    </div>
                </div>
            </div>
        </div>
        <div>
            <div class="pt-32 flex px-[75px] justify-center space-x-4">
                <a href="#" class="block max-w-sm p-6 hover:bg-gray-100 dark:bg-white dark:hover:bg-[#F4F4F4]">
                    <img src="/images/lapfutsal.png" alt="">
                    <h3 class="mb-2 text-xl tracking-tight text-[#363636]">Pandawa Futsal</h3>
