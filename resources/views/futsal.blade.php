...
@section('content')
    <div class="flex flex-col w-full">
        <div class="relative w-full">
            <img src="/images/bgfutsal.png" alt="" srcset="" class="w-full">
            <div
                ...
                <div class="bg-[#80D8FB] w-[560px] h-[129px] flex rounded-xl shadow-xl m-auto font-rubik">
                    <div class="flex m-auto space-x-4">
                        <img src="/images/vectorfutsal.png" alt="">
                        <h1 class="text-6xl font-bold">Futsal</h1>
                    </div>
                </div>
            </div>
        </div>
        <div>
            <div class="pt-32 flex flex-row flex-wrap px-[75px] justify-center space-x-4">
                ...
                @foreach ($lapangans as $lapangan)
                    <a href="/order/{{ $lapangan->id }}"
                        class="block max-w-sm p-6 hover:bg-gray-100 dark:bg-white dark:hover:bg-[#80D8FB]">
                        <img src="{{ asset($lapangan->photo) }}" alt="{{ $lapangan->venueName }}" class="w-96 h-96 object-cover">
                        <h3 class="mt-5 mb-2 text-2xl font-bold tracking-tight text-[#363636] font-montserrat">
                            {{ $lapangan->venueName }}</h3>
