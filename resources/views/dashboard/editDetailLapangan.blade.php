...
@section('content')
    <form action="{{ route('dashboard.lapangan.update', $lapangan['id']) }}" method="POST" class="mt-[38px] w-full mx-[55px]" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
            ...
            <div class="flex flex-col gap-[22px] ml-[21px] pt-[69px]">
                <div class="flex flex-row gap-[75px] content-center">
                    ...
                    <input
                        ...
                        placeholder="Masukkan nama lapangan anda!" id="venueName" name="venueName" type="text" value="{{ $lapangan['venueName'] }}">
                </div>
                <div class="flex flex-row gap-[75px] content-center">
                    <div class="w-48 flex content-center">
                ...
                <div class="flex flex-row gap-[75px] content-center">
                    ...
                    <input
                        value="{{ $lapangan['oprTime'] }}"
                        id="oprTime" name="oprTime"
                        class="w-[575px] h-[53px] rounded-lg bg-[#3F95C5] focus:outline-none px-3  placeholder:text-white/[0.3] font-bold text-white"
                ...
                <div class="flex flex-row gap-[75px] content-center">
                    ...
                    <div class="flex flex-row gap-[63px]">
                        <input type="checkbox" value="1" id="wifi" name="wifi" class="peer/wifi hidden" @if( $lapangan['wifi'] == 1 ) checked  @endif/>
                        <label for="wifi"
                        ...
                        <input type="checkbox" value="1" id="toilet" name="toilet" class="peer/toilet hidden" @if( $lapangan['toilet'] == 1 ) checked  @endif/>
                        <label for="toilet"
                        ...
                        <input type="checkbox" value="1" id="canteen" name="canteen" class="peer/kantin hidden" @if( $lapangan['canteen'] == 1 ) checked  @endif/>
                        <label for="canteen"
                        ...
                        <input type="checkbox" value="1" id="musalla" name="musalla" class="peer/musholla hidden" @if( $lapangan['musalla'] == 1 ) checked  @endif/>
                        <label for="musalla"
                ...
                <div class="flex flex-row gap-[75px] content-center">
                    <div class="w-48 flex content-center">
                        <label class="flex items-center justify-center text-white font-semibold text-lg" for="photo">Upload Foto</label>
                    </div>
                    <div
                        class="w-[575px] py-2 rounded-lg bg-[#3F95C5] flex flex-col px-3  placeholder:text-white/[0.3] font-bold text-white">
                        <div class="flex justify-center my-4">
                            <input type="file" id="photo" name="photo" value="{{ $lapangan['photo'] }}">
                        </div>
                    </div>
                </div>
            </div>
