...
@section('content')
    <form action="{{ route('dashboard.lapangan.store') }}" method="POST" class="mt-[38px] w-full mx-[55px]" enctype="multipart/form-data">
        {{ csrf_field() }}
            ...
            <div class="flex flex-col gap-[22px] ml-[21px] pt-[69px]">
                ...
                <div class="flex flex-row gap-[75px] content-center">
                    ...
                    <div class="flex flex-row gap-[63px]">
                        ...
                        <input type="checkbox" value="1" id="musalla" name="musalla" class="peer/musholla hidden"/>
                        <label for="musalla"
