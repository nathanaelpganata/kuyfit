...
@section('content')
    ...
    {{-- Step Start --}}
    <form x-data="{step: 1}" action="store" method="POST" enctype="multipart/form-data">
    {{ csrf_field()  }}
    {{-- Step 1 --}}
    ...
    <div class="flex flex-col items-center justify-center pb-20" x-show="step==4">
        <div class="flex flex-col items-center justify-center bg-[#CFF2FF] rounded-[30px] w-[563px] py-8 px-20">
            ...
            <button type="submit" class="w-11/12 py-1.5 rounded-[4px] text-white font-semibold bg-blue-400 mt-8 text-center">Kirim</button>
        </div>
    </div>
