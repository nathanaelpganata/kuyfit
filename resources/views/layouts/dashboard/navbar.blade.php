<nav
    ...
    <div class="relative">
        ...
        <div
            class="bg-[#057DB6] hover:flex hidden absolute peer-hover:flex -bottom-14 inset-x-0 justify-center py-3 items-center rounded-b-xl z-10">
            <a href="/logout"
                class="flex w-full mx-3 py-1 justify-center  bg-red-700 hover:bg-red-900 font-bold text-white rounded-xl">Logout</a>
        </div>
    </div>
</nav>
