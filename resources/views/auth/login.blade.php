...
<div class="flex flex-row justify-center items-center h-screen gap-0 xl:gap-10 px-6 my-20 md:my-0">
    <div class="flex flex-col w-full lg:w-[650px]">
        ...
        <form class="flex flex-col gap-4 mt-6">
            ...
            <input type="email" class="border border-gray-400 rounded-lg py-2 px-3 focus:outline-none focus:border-blue-400" placeholder="Insert your email here.">
            <label class="text-lg font-medium">Password</label>
            <input type="password" class="border border-gray-400 rounded-lg py-2 px-3 focus:outline-none focus:border-blue-400" placeholder="Insert your Password here.">
            <button type="submit" class="bg-blue-500 text-white font-medium py-2 rounded-lg hover:bg-blue-600 transition-colors">Login</button>
        </form>
        <div class="flex flex-col items-center justify-center mt-6">
            <p class="text-lg">Don't have an account? <a href="#" class="text-blue-500 hover:underline">Sign up</a></p>
