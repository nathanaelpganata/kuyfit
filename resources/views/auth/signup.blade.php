        ...
        <form action="/register" method="POST" class="flex flex-col items-center md:items-stretch mt-10">
            ...
            <div class="flex flex-col space-y-4">
                ...
                <div class="flex flex-col">
                    ...
                    <span>+62 |</span>
                    <input type="number" id="phone" class="bg-transparent ml-2 px-2 outline-none" placeholder="85627392142">
                    </div>
                    @error('phone')
                        <span class="text-red-500 text-sm font-thin">{{ $message }}</span>
                    @enderror
                ...
                <div class="flex flex-col">
                    ...
                    <select type="select" id="account_type" class="w-72 bg-slate-200 px-2 py-1 mt-1 outline-none">
            ...
            <div>
                <div class="flex items-center  mt-4">
                    <input type="checkbox" class="-translate-y-2 mr-2" id='agreement' >
                    <label for='agreement' class="whitespace-pre-line text-sm">Creating an account means you’re okay with our <a href="#" class="text-blue-600 hover:text-blue-800 underline text-sm decoration-blue-600 hover:decoration-blue-800">Terms of Service</a>,
